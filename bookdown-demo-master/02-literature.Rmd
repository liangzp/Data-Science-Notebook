...
### 服务器配置
参考教程
[linux安装python](https://blog.51cto.com/13760351/2385907)
[linux配置jupyter lab](https://blog.csdn.net/weixin_42014622/article/details/102560859)
#### 创建用户
adduser 新增用户
passwd 设置密码
#### 下载和安装python
...
直接使用anaconda而不是安装python，但是一定不要在root目录下安装anaconda
